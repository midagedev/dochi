...
로컬 디바이스 제어 아이디어는 [Claude Code](https://claude.ai/code)와 [OpenClaw](https://github.com/nicepkg/openclaw)에서 영향을 받았습니다. 거기에 macOS 네이티브, 워크스페이스 기반 맥락 관리, 홈 어시스턴트 등 개인적으로 필요한 것들을 중심으로 만들고 있습니다.
