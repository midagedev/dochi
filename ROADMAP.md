...
## Phase 4 — 멀티 에이전트 + 컨텍스트 고도화

여러 에이전트가 각자의 페르소나로 동작하고, 멀티 워크스페이스에서 컨텍스트를 관리하는 시스템.
...
- [ ] 멀티 워크스페이스 — 가족/팀 등 목적별 워크스페이스 생성 및 전환
- [ ] 워크스페이스 기억 — 멤버 전체가 공유하는 워크스페이스 단위 기억
- [ ] 에이전트별 기억 분리 — 워크스페이스 기억 + 에이전트 고유 기억
- [ ] 개인 컨텍스트 — 사용자 소유, 워크스페이스 횡단, 직접 편집 UI
- [ ] 디바이스 멀티 워크스페이스 등록 — 하나의 디바이스가 여러 워크스페이스에 동시 참여
