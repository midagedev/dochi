...
개인 단말을 위한 범용 LLM 인터페이스. macOS 앱, CLI, 텔레그램, 슬랙 등 다양한 인터페이스에서 동일한 컨텍스트로 AI를 사용할 수 있습니다.

가족 대화 상대, 개발 보조, 업무 어시스턴트 — `system.md` 하나로 페르소나를 바꿔가며 쓸 수 있고, 클라우드 동기화로 기기 간 컨텍스트를 공유합니다.
